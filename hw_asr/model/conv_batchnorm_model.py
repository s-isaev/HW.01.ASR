...
class ConvBatchnormModel(BaseModel):
    def __init__(self, n_feats, n_class, *args, **kwargs):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=2, kernel_size=4, padding='same')
        self.conv2 = nn.Conv1d(in_channels=2, out_channels=2, kernel_size=4, padding='same')
        self.conv3 = nn.Conv1d(in_channels=2, out_channels=2, kernel_size=4, padding='same')
